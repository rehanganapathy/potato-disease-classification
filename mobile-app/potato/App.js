...
const App = () => {
  ...
  return (
    <View style={[backgroundStyle, styles.outer]}>
      ...
      <ImageBackground
        blurRadius={10}
        source={{uri: 'https://wallpapercave.com/wp/wp4937501.jpg'}}
      ...
      <View style={styles.btn}>
        <TouchableOpacity
          ...
          <Image source={{uri: 'https://i.pinimg.com/originals/e2/bc/2b/e2bc2b005d593253f62a4727d3da5d4f.png'}} style={styles.imageIcon} />
        </TouchableOpacity>
        <TouchableOpacity
          activeOpacity={0.9}
          onPress={() => manageCamera('Photo')}
          style={styles.btnStyle}>
          <Image source={{uri: 'https://cdn-icons-png.flaticon.com/512/1375/1375106.png'}} style={styles.imageIcon} />
        </TouchableOpacity>
      </View>
    </View>
  );
